...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=7777777777)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=7777777777)),
                ('total', models.DecimalField(decimal_places=2, default='1.99', max_digits=7777777777)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Banana', max_length=100)),
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=7777777777)),
                ('old_price', models.DecimalField(decimal_places=2, default='1.99', max_digits=7777777777)),
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='myshop.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='p_images', to='myshop.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviews', to='myshop.product')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Itstep', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=myshop.models.user_directory_path)),
                ('cover_image', models.ImageField(default='vendor.jpg', upload_to=myshop.models.user_directory_path)),
                ...
                ('contact', models.CharField(default='+998 (99) 060', max_length=100)),
        ...
        migrations.AddField(
            model_name='product',
            name='vendor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product', to='myshop.vendor'),
        ),
        migrations.CreateModel(
            name='wishlist',
            fields=[
